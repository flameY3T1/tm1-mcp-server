...
**Stand:** 2026-06-07 (Sandbox + Multi-Instanz won't-do entschieden; Tool-Count 105)
...
|---|---|---|---|
| **`tm1_get_audit_log`** | `/AuditLogEntries` | S | Compliance/Forensik: wer hat wann Metadaten/Security geändert. Message-/Transaction-/Error-Log vorhanden, AuditLog fehlt. **Nächster Kandidat.** |
...
1. **`tm1_get_audit_log` + `tm1_create_native_view`** — je S, rundet Lücken ab.
