...
export const KNOWN_SIGNATURES: Map<string, TiKnownSignature> = new Map([
  ...
  [
    "char",
    {
      ...
      minParams: 1,
      maxParams: 1,
      params: [{ name: "Number", type: "numeric" }],
      returnType: "string",
    },
  ],
  [
  ...
  [
    "cubeattrdelete",
    {
      ...
      minParams: 1,
      maxParams: 1,
      params: [{ name: "AttributeName", type: "string" }],
      returnType: "void",
    },
  ],
  ...
  [
    "stringglobalvariable",
    {
      ...
      minParams: 1,
      maxParams: 1,
      params: [{ name: "VariableName", type: "string" }],
      returnType: "void",
    },
  ],
  [
  ...
  [
    "newdateformatter",
    {
      ...
      performanceNote: {
        recommended: "prolog",
        reason:
          "NewDateFormatter creates a formatter object and should be created only once in the prolog, not per record.",
      },
    },
  ],
  [
