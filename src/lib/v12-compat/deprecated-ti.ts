...
export const V12_DEPRECATED_TI: ReadonlyMap<string, DeprecatedTiEntry> =
  new Map(
    [
      {
        ...
        severity: "error",
        issue:
          "Cube restriction API removed in v12 — security moves to Cloud IAM",
      ...
      },
      {
        ...
        suggestion:
          "Remove without replacement — external calls go through the PA connector layer",
      },
      {
      ...
      },
      {
        ...
        severity: "error",
        issue:
          "BatchUpdate mode removed in v12 — the cloud engine optimizes automatically",
      ...
      },
      {
        ...
        severity: "error",
        issue:
          "Manual persistence removed in v12 — the cloud engine persists automatically",
        suggestion: "Remove without replacement",
      },
      {
      ...
      },
      {
        ...
        suggestion:
          "Remove without replacement — the cloud engine optimizes automatically",
      },
      {
      ...
      },
      {
        ...
        severity: "error",
        issue:
          "Shell execution removed in v12 (cloud sandbox allows no OS calls)",
      ...
      },
      {
        ...
        suggestion:
          "Remove without replacement — locking via the sandbox model",
      },
      {
        name: "LockOn",
        severity: "error",
      ...
      },
      {
        ...
        suggestion:
          "Remove without replacement — the engine refreshes automatically",
      },
      {
      ...
      },
      {
        ...
        severity: "error",
        issue:
          "SaveDataAll removed in v12 — the cloud engine persists automatically",
        suggestion: "Remove without replacement",
      },
      {
        name: "ServerShutdown",
    ...
    ].map((e): [string, DeprecatedTiEntry] => [
      e.name.toLowerCase(),
      e as DeprecatedTiEntry,
    ]),
  );
