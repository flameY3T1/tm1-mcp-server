...
- `tm1_check_feeders` — Check the feeders of a cell: returns the cells fed by this cell, each with a fed flag — fed=false marks a broken or missing feeder (the classic cause of empty c
